...
const Team = () => {
  ...
  return (
    <section id="team" className="py-24 relative overflow-hidden bg-brand-darker grid-bg border-b border-black/4">
          ...
          <AnimatePresence mode="wait">
            {teamData[activeTab].map((person, index) => (
              <motion.div
                ...
                className="bg-white border border-black/4 p-6 rounded-3xl flex flex-col justify-between h-full relative group overflow-hidden shadow-[0_15px_40px_rgba(15,23,42,0.02)] hover:shadow-lg transition-all duration-300"
              >
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2 border-t border-black/3 pt-4">
